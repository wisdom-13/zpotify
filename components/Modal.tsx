      ...
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Close asChild>
            <button
              className='text-neutral-400 hover:text-white absolute top-[10px] right-[10px] inline-flex h-[25px] w-[25px] appearance-none justify-center items-center rounded-full focus:outline-none'
            >
              <IoMdClose />
            </button>
          </Dialog.Close>
